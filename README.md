...
| [Gram](https://github.com/speakeasy-api/gram)                                    | 🟢 Open source | Gram is an open-source control plane for agents and MCPs that records tool, permission-change, and access events.                                                                                                                                            |
